/******************************************************************************\
* Copyright (C) 2015-2017 GeeFish Motion, Inc. All rights reserved.               *
* GeeFish Motion proprietary and confidential. Not for distribution.              *
 ...
 *
 * The GeeFish Motion software employs a right-handed Cartesian coordinate system.
 * Values given are in units of real-world millimeters. The origin is centered
 * at the center of the GeeFish Motion Controller. The x- and z-axes lie in the horizontal
 ...
 *
 * \image html images/GeeFish_Axes.png
 * @since 1.0
 */
struct Vector {
  /**
  ...
  /**
   * Convert a GeeFish::Vector to another 3-component Vector type.
   *
  ...
  /**
   * Convert a GeeFish::Vector to another 4-component Vector type.
   *
...
struct Matrix
{
  ...
  /**
   * Convert a GeeFish::Matrix object to another 3x3 matrix type.
   *
  ...
  /**
   * Convert a GeeFish::Matrix object to another 4x4 matrix type.
   *
   * The new type must define a constructor function that takes each matrix
   * element as a parameter in row-major order.
   * @since 1.0
